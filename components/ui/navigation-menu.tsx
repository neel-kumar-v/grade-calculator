...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-30 data-[motion=from-start]:slide-in-from-left-30 data-[motion=to-end]:slide-out-to-right-30 data-[motion=to-start]:slide-out-to-left-30 top-0 left-0 w-[calc(100%+0.1rem)] p-2 pr-2.5 md:absolute md:w-[calc(100%+0.1rem)]",
